...
data <- read_excel("/Users/elena/Desktop/Data source/Municipalities.xlsx", skip = 1) %>%
  slice(-n()) %>%  
...
comuni = read_sf("/Users/elena/Desktop/Data source/Limiti01012024/Com01012024/Com01012024_WGS84.shp")%>%
...
map_bubbles <- tm_shape(sf) + 
  ...
  tm_layout(
    title = "Ukrainians in Italy - 2023 | From Ihor Hrudnyy for Nova Post with ❤",
    title.size = 1.2,
...
```{r}
ui <- fluidPage(
  titlePanel("Ukrainians in Italy - 2023 | From Ihor Hrudnyy for Nova Post with ❤"),
